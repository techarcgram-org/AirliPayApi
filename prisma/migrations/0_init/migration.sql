...
-- CreateIndex
CREATE INDEX "index_accounts_on_address_id" ON "accounts"("address_id");

-- CreateIndex
CREATE INDEX "index_admins_on_account_id" ON "admins"("account_id");

-- CreateIndex
CREATE INDEX "index_client_payments_on_client_id" ON "client_payments"("client_id");

-- CreateIndex
CREATE INDEX "index_clients_on_account_id" ON "clients"("account_id");
...
-- AddForeignKey
ALTER TABLE "accounts" ADD CONSTRAINT "fk_rails_198f25c0c3" FOREIGN KEY ("address_id") REFERENCES "addresses"("id") ON DELETE NO ACTION ON UPDATE NO ACTION;

-- AddForeignKey
ALTER TABLE "admins" ADD CONSTRAINT "fk_rails_14a59fabad" FOREIGN KEY ("account_id") REFERENCES "accounts"("id") ON DELETE NO ACTION ON UPDATE NO ACTION;
...
-- AddForeignKey
ALTER TABLE "clients" ADD CONSTRAINT "fk_rails_bed59fd791" FOREIGN KEY ("account_id") REFERENCES "accounts"("id") ON DELETE NO ACTION ON UPDATE NO ACTION;
...
-- AddForeignKey
ALTER TABLE "users" ADD CONSTRAINT "fk_rails_61ac11da2b" FOREIGN KEY ("account_id") REFERENCES "accounts"("id") ON DELETE NO ACTION ON UPDATE NO ACTION;
